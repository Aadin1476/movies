...
USERNAME = environ.get('USERNAME', "https://t.me/Raistar_RG") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002470128296'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+OH9-wXN-4mU2ZTM1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002190681742').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aadinaa953:<db_password>@nxl.8whdo.mongodb.net/?retryWrites=true&w=majority&appName=NXL")
DATABASE_NAME = environ.get('DATABASE_NAME', "aadinaa953")
